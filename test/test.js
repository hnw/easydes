...
test('正常系テスト(string)', t => {
  ...
  t.is((new Easydes('bfoobarbaz')).decrypt('//+JJMw0ZUQdkJkwrJpI2A=='),
       'abcd');
});

test('正常系テスト(array)', t => {
  const cipher = new Easydes('bfoobarbaz');
